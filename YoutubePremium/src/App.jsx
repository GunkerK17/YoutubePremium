  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        <header
          className={`h-14 border-b backdrop-blur-sm flex items-center justify-between px-6 flex-shrink-0 transition-colors duration-300 ${
            dark
              ? 'border-white/5 bg-[#0d0d0f]/80'
              : 'border-zinc-200 bg-white/80'
          }`}
        >
          <div />

          <span className={dark ? 'text-xs text-zinc-500' : 'text-xs text-zinc-500'}>
